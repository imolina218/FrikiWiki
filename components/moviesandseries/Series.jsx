...
const Series = ({publicKey}) => {
    ...
    let api = `https://www.omdbapi.com/?apikey=${publicKey}&s=${search}&type=series&page=${pageNumber}`;
    ...
    useEffect(() => {
        ...
        if(modal) {
            let apiInfo = `https://www.omdbapi.com/?apikey=${publicKey}&i=${info.result.imdbID}&plot=full&type=serie`;
            (async function(){
